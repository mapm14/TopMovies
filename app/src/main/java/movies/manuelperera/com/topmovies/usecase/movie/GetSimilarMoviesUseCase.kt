...
open class GetSimilarMoviesUseCase(private val movieService: MovieService,
    ...
    open fun testObserver(): TestObserver<Transaction<MoviesListAppDomain>> = movieService.getSimilarMovies().test()
